...
QuestionList CreateEnglishPhraseExam()
{
    const struct
    {
        const char* phrase;     //  定型文の型
        const char* meaning;    //  定型文の意味
        const char* example;    //  英語の例文
        const char* tramslation;//  例文の日本語訳
    ...
    }data[] =
    {
        ...
        "According to the weather forcast, today is rain","天気予報によると、今日は雨だ",
        2,{0,1}},
